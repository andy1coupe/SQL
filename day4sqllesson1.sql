...
DROP DATABASE booksauthors; #creates database, #drop database booksauthors 
...
authorname VARCHAR(30) DEFAULT NULL, #creates part of the table and each value can have a max of 30 characters
